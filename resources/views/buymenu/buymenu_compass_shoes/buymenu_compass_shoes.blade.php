    ...
    <header>
        ...
        <div class="navbar-wrapper">
            ...
            <div class="johnsonlogo-wrapper">
                <img src="{{ asset('img/brand/Compass_brand/Logo_compass.png') }}" class="compass" />
            ...
            <div class="content-section">
                ...
                <div class="content-right">
                    ...
                    <div class="namasepatu">
                        ...
                        <p><del style="color: red">Rp. {{ number_format($product->discount, '0', ',', '.') }}</del> Rp.

...
@section('content')
    ...
    <div class="mt-10 mb-10">
        <div class="flex justify-center">
            <img src="{{ asset('img/brand/Johnson_brand/Logo_johnson.png') }}" alt="Logo Johnson"
            ...
            <div class="flex justify-center align-middle mb-[48px]">
                <div class="max-w-[1430px] p-14 rounded-lg shadow-2xl bg-secondary font-poppins">
                    ...
                    <p class="font-normal text-font3 text-center">
                        Johnson adalah salah satu brand sepatu lokal asal Bandung, Indonesia yang berdiri sejak 2019.
                        Brand ini mengusung konsep #GayaGaPakeMahal karena ingin menciptakan sepatu berkualitas dengan harga
                        yang pas di kantong semua kalangan. Harga murah bukan berarti murahan.
                    </p>
                    ...
                    <p class="font-normal text-font3 mt-5 text-center">
                        ...
                        Mereka juga memiliki berbagai edisi khusus seperti "Galaxy X Edition" dan kolaborasi dengan "One
                        Piece" yang mencakup berbagai karakter seperti Luffy, Zoro, Chopper, Robin, dan Brook.
                    </p>
                    <!-- Paragraf deskripsi ketiga area -->
                    <p class="font-normal text-font3 mt-5 text-center">
                        Johnson Indonesia tidak hanya menyediakan produk alas kaki yang bervariatif, tetapi juga memperluas
                        ke produk apparel. Dengan demikian, Johnson menawarkan berbagai pilihan untuk konsumen di semua
                        kalangan.
                    </p>
                </div>
            </div>
